...
class SalesPersonController extends Controller
{
    ...
    {
        $salespersons = User::role('salesperson')->with('showroom:id,name,location')->when($request->has('search'), function($query) use ($request) {
    ...
    public function store(StoreRequest $request)
    {
        try {
            ...
            return redirect(route('admin.salesperson.index'))->with('message', [
                'type' => 'success',
    ...
    {
        return Inertia::render('Admin/Sales/Leaderboard', [
    ...
    public function delete(User $user)
    {
        try {
            ...
            return redirect(route('admin.salesperson.index'))->with('message', [
                'type' => 'success',
                'message' => 'Sales Person Has Been Deleted Successfully'
            ]);
        } catch (\Error $error) {
            return back()->with('message', [
                'type' => 'error',
