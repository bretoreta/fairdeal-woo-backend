    ...
    <div class="sticky top-0 z-[60] w-full">
        <div class="bg-white py-2 px-6 border flex justify-between">
            <div class="flex lg:hidden items-center">
                <button class="p-2 bg-gray-100 rounded-md" @click="$emit('toggleSidebar')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" class="w-5 h-5 text-gray-600">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
                    </svg>
                </button>
            </div>
            <div class="flex items-center justify-end gap-x-3 lg:divide-x w-full">
