                ...
                <Dropdown :width="48">
                    ...
                    <template #content>
                        ...
                        <div class="flex flex-col">
                            <NavbarLink showAs="button" v-if="!customer.email_verified_at" :link="route('employees.customers.verify', customer.username)" label="Verify">
                                <template #icon>
                            ...
                            <NavbarLink showAs="button" v-if="customer.email_verified_at" :link="route('employees.customers.unverify', customer.username)" label="Unverify">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                            ...
                            <NavbarLink showAs="button" v-if="customer.status != 'active' && customer.status != 'closed'" :link="route('employees.customers.activate', customer.username)" label="Activate">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                            ...
                            <NavbarLink showAs="button" v-if="customer.status != 'pending' && customer.status != 'closed'" :link="route('employees.customers.deactivate', customer.username)" label="Deactivate">
                                <template #icon>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
