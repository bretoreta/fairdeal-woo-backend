...
const submit = () => {
    form.post(route('employees.salesperson.store'));
};
</script>

<template>
    <EmployeeLayout title="Create Sales Person" page-header="Create Sales Person" page-sub-header="Create a sales person from here.">
