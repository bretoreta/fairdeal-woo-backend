...
<template>
    <EmployeeLayout title="Show Sales Person" :page-header="'Viewing Sales Person | ' +  salesperson.name" page-sub-header="Manage sales persons from here.">
        <div class="flex items-baseline justify-between pb-4">
            <Link :href="route('employees.salesperson.index')" class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2" variant="outline">
                Go Back
            </Link>
            <Dropdown :width="48">
                <template #trigger>
                        ...
                        <div class="flex-1 rounded-md border p-5">
                            ...
                            <div class="mt-4">
                                ...
                                <template v-for="click in salesperson.clicks" :key="click.id">
                                    <div class="my-2 border rounded-md px-4 py-2 bg-gray-50 dark:bg-muted/40">
